...
module.exports = {
     ...
     * @param {String} url YouTube Video URL
     * @param {String} server (avaiable: `id353`, `en60`, `en61`, `en68`)
     */
    yta(url, server = 'id353') { return yt(url, '128kbps', 'mp3', '128', server) },
    /**
     * Download YouTube Video as Video via y2mate
     * @param {String} url YouTube Video URL
     * @param {String} server (avaiable: `id353`, `id354`, `id355`, `id356`, `id357`, `id358`, `id359`, `id360`, `en425`, `en426`, `en427`, `en426`)
     */
    ytv(url, server = 'en68') { return yt(url, '360p', 'mp4', '360', server) },
    yt480(url, server = 'en68') { return yt(url, '480p', 'mp4', '480', server) },
    yt720p(url, server = 'en68') { return yt(url, '720p', 'mp4', '720', server) },
    servers: ['id353', 'id354', 'id355', 'id356', 'id357', 'id358', 'id359', 'id360', 'en425', 'en426', '427', 'en426']
}
